...
class Boot extends Phaser.State {
    ...
    create() {
        ...
        //set title
        if(this.title1) {
            this.game.physics.arcade.enable(this.title1);
            this.title1.body.immovable = true;
            this.title1.body.checkCollision.up = false;
            this.title1.body.checkCollision.left = false;
            this.title1.body.checkCollision.right = false;

            //this.titleStar = this.game.add.sprite(this.title.centerX, this.title.centerY, 'star');
            //this.titleStar.anchor.set(0.5);
        }


        this.player = this.game.add.sprite(this.world.centerX, this.camera.y, 'dude', 4);
    ...
    update() {
        ...
        this.game.physics.arcade.collide(this.player, this.title1, this.reachTitle, null, this);
    ...
    reachTitle(player, title) {
        if(!this.titleTween) {
            this.titleTween = this.game.add.tween(this.title1).to({y: this.title1.y - 30}, 200,Phaser.Easing.Linear.none, true, 0, 0, true);
        } else {
